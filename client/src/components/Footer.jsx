        ...
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full">
            <div className="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-500/30">
                ...
                <div className="max-w-96">
                    <img src={assets.logo} alt="Toolie AI Logo" className='w-42 sm:w-44' />
                    <p className="mt-6 text-sm text-gray-500">
                        Toolie AI is a modern SaaS platform offering a suite of AI-powered tools to supercharge your productivity, Inspired by leading AI SaaS products.
                    </p>
            ...
            <p className="py-4 text-center text-xs md:text-sm text-gray-500">
                Copyright 2025 © <a href="https://prebuiltui.com">Toolie AI</a>. All Right Reserved.
            </p>
        </footer>
    );
};